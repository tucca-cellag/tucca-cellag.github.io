        ...
        <Columns>
          ...
          <Column className="text--center">
            <div data-aos="fade-right" data-aos-duration="1500">
              <Card shadow="tl">
                <CardHeader>
                  <h2>Archana Nagarajan</h2>
                </CardHeader>
                <CardImage
                  cardImageUrl="/img/anagarajan.png"
                  alt="Archana Nagarajan"
                  title="Archana Nagarajan"
                  className={cardImageStyles.ourTeamCardImage}
                />
                <CardBody className="text--left">
                  Archana Nagarajan, PhD, is a Post-Doctoral Researcher at Tufts
                  University, specializing in cultured meat, neuroscience,
                  bioinformatics, and computational biology. With a Ph.D. in
                  Neuroscience from Tufts University Graduate School of
                  Biomedical Sciences (2024) and a B.A. in Biochemistry from
                  Barnard College of Columbia University (2017), Archana is an
                  expert in RNA sequencing, WGCNA, and clinical biostatistics.
                  Originally from Victoria, British Columbia, Canada, she enjoys
                ...
                <CardFooter>
                  <div className="button-group">
                    <IconButton
                      component="a"
                      href="mailto:archana.nagarajan@tufts.edu"
                      aria-label="Email"
                      sx={{
                        color: "var(--ifm-color-primary)",
                        "&:hover": {
                    ...
                    <IconButton
                      component="a"
                      href="https://orcid.org/0009-0003-2668-1270" // Replace with actual ORCID
                      aria-label="ORCID"
                      sx={{
                        color: "var(--ifm-color-primary)",
                        "&:hover": {
                    ...
                    <IconButton
                      component="a"
                      href="https://github.com/datacalf39" // Replace with actual GitHub
                      aria-label="GitHub"
                      sx={{
                        color: "var(--ifm-color-primary)",
                        "&:hover": {
