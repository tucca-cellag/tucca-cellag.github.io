...
<Button
  label="Setting Up a Fresh Project"
  link="/tucca-rna-seq/fresh-project-install"
  variant="primary"
/>
    ...
    **SSH**, or **Secure Shell**, is a protocol that allows you to securely
    ...
    <Tabs>
      ...
      <TabItem value="hpc-welcomepage" label="Tufts HPC's Welcome Page">
        ...
        <Button
          label="Tufts HPC's Welcome Page"
          link="https://it.tufts.edu/high-performance-computing/hpc-welcome-page"
          variant="primary"
        />
      ...
      <TabItem value="hpc-newuser" label="Tufts HPC's New User Support" default>
        ...
        <Button
          label="Tufts HPC's New User Support"
          link="https://tufts.app.box.com/v/HPC-New-User/folder/46988375653"
          variant="primary"
        />
