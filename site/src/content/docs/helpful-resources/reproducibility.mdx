---
title: "Reproducibility: Our Computational Ethos"
description: The standard TUCCA holds itself to across every project — reproducible computational science — and how we encourage others to do the same.
---
...
At TUCCA, reproducibility isn't an afterthought — it's the standard we build into
every computational project, from RNA-seq workflows to computational protein design.
Reproducible work is verifiable, extensible, and durable: others (and our own future
selves) can rerun it, trust it, and build on it. We share the practices below both as
the bar we hold ourselves to and as an invitation to the wider cellular-agriculture
and computational-biology community — open, reproducible science moves the whole field
forward.
...
<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden;">
  <iframe
    src="https://www.youtube.com/embed/2ReR1YJrNOM"
...
<Columns style="margin-bottom: 20px;">
  <Column style="display: flex;">
    <Card shadow="md" style="margin-top: 20px; flex-grow: 1;">
      <CardHeader>
  ...
  <Column style="display: flex;">
    <Card shadow="md" style="margin-top: 20px; flex-grow: 1;">
      ...
      <CardBody>
        ...
        <p style="margin-top: 10px; margin-bottom: 4px; font-size: 0.9em; font-style: italic;">
