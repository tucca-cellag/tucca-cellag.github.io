...
description: How TUCCA approaches reproducible computational science, and how we encourage others to do the same.
---
...
At TUCCA, we build reproducibility into every computational project from the start,
across RNA-seq workflows and computational protein design alike. Reproducible work is
verifiable, extensible, and durable: others (and our own future selves) can rerun it,
trust it, and build on it. We share the practices below both as the bar we hold
ourselves to and as an invitation to the wider cellular-agriculture and
computational-biology community. Open, reproducible science moves the whole field
forward.
