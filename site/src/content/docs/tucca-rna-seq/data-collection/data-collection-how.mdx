...
description: A comprehensive template of the experiment metadata to collect before running an RNA-seq analysis.
---
...
:::note[Interactive Visualization Capabilities]
