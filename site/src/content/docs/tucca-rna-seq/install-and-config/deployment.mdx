...
description: Recommended deployment strategies for tucca-rna-seq, from layered Singularity/Conda environments to HPC, cloud, and CI execution platforms.
---
...
The most reliable and reproducible way to run this workflow is by combining
...
:::caution[A Note on Installation]
...
:::caution[Local Execution Limitations]
...
Snakemake can use **storage plugins** to access data from various
...
<Tabs>
  <TabItem label="HPC Carpentry Lessons">
    <p>
  ...
  <TabItem label="Tufts HPC Home Page">
    <p>
  ...
  <TabItem label="Tufts HPC User Guide">
    <p>
...
- **Remote Development**: VSCode can connect to remote servers,
