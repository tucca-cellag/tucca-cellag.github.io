...
description: How Snakemake, Conda, and containers combine to make the tucca-rna-seq bioinformatics workflow reproducible.
---
...
<Card shadow="md" style="margin-bottom: 10px">
  <CardBody>
    <CardImage
  ...
  <CardFooter>
    <p style="font-size: 0.8em; font-style: italic">Image Credit: https://commons.wikimedia.org/wiki/File:Snakemake_logo_dark.png</p>
  </CardFooter>
</Card>
...
produce (a prepared component of the final dish).
 ...
 <Card shadow="md" style="margin-bottom: 10px">
  ...
  <CardFooter>
    <p style="font-size: 0.8em; font-style: italic">Image Credit: https://www.rc.virginia.edu/userinfo/hpc/software/snakemake/</p>
  </CardFooter>
</Card>
...
<Columns>
  <Column style="margin-bottom: 20px">
    <Card shadow="md">
      ...
      <CardFooter>
        <p style="font-size: 0.8em; font-style: italic">Image Credit: https://fluidvisual.com/flowchartrecipes/</p>
      </CardFooter>
    </Card>
  </Column>
  ...
  <Column>
    <Card shadow="md" style="margin-top: 20px">
      ...
      <CardFooter>
        ...
        detailed tutorial on how to use the workflow management system for
    ...
    <Card shadow="md" style="margin-top: 20px">
      ...
      <CardBody>
        <YouTube
          ...
          title="An introduction to Snakemake"
        />
      </CardBody>
      <CardFooter>
