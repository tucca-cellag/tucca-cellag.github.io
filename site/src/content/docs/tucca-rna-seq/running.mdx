---
title: Running the tucca-rna-seq Workflow
description: How to execute the tucca-rna-seq workflow using execution profiles, plus monitoring, debugging, and resource management.
---
...
For a detailed guide on what profiles are, which ones are available in this
workflow, and how to customize them for your specific needs, please see the
[**Configuration Guide**](/tucca-rna-seq/install-and-config/configuration/#profile-configuration).
...
Before performing a dry-run, you need to create the necessary software
...
:::note[Enabled by Default in the Slurm Profile]
...
[Configuration Guide](/tucca-rna-seq/install-and-config/configuration/#profile-examples-from-tucca-rna-seq)
for details.
:::
...
For more advanced usage and customization, see the [Advanced Configuration](/tucca-rna-seq/install-and-config/configuration/) guide.
